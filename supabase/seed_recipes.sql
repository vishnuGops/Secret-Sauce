...
begin
  ...
  perform seed_recipe_v2(
    ...
    $sr$[{"name":"Filling","ingredients":[{"quantity":2,"unit":null,"name":"nectarines","note":"chopped","is_optional":false,"food_id":"nectarine"},{"quantity":1.5,"unit":"cup","name":"fresh blueberries","note":null,"is_optional":false,"food_id":"blueberries"},{"quantity":0.5,"unit":"Tbsp","name":"lemon zest","note":null,"is_optional":false,"food_id":"lemon-zest"},{"quantity":1,"unit":"Tbsp","name":"fresh lemon juice","note":null,"is_optional":false,"food_id":"lemon-juice"},{"quantity":0.25,"unit":"cup","name":"organic cane sugar","note":"adjust to the sweetness of the fruit","is_optional":false,"food_id":"granulated-sugar"},{"quantity":2,"unit":"Tbsp","name":"cornstarch","note":null,"is_optional":false,"food_id":"cornstarch"}]},{"name":"To assemble","ingredients":[{"quantity":1,"unit":null,"name":"refrigerated pie crust","note":null,"is_optional":false,"food_id":"pie-crust"},{"quantity":1,"unit":null,"name":"egg","note":"beaten with 1 Tbsp water, for egg wash","is_optional":false,"food_id":"egg"},{"quantity":null,"unit":null,"name":"turbinado sugar","note":"for garnish","is_optional":false,"food_id":"turbinado-sugar"}]}]$sr$::jsonb,
  ...
  perform seed_recipe_v2(
    ...
    $sr$[{"name":"","ingredients":[{"quantity":170,"unit":"g","name":"butter","note":null,"is_optional":false,"food_id":"butter"},{"quantity":150,"unit":"g","name":"brown sugar","note":null,"is_optional":false,"food_id":"brown-sugar"},{"quantity":100,"unit":"g","name":"white sugar","note":null,"is_optional":false,"food_id":"granulated-sugar"},{"quantity":1,"unit":null,"name":"egg","note":null,"is_optional":false,"food_id":"egg"},{"quantity":1,"unit":null,"name":"egg yolk","note":null,"is_optional":false,"food_id":"egg-yolk"},{"quantity":1,"unit":"tsp","name":"vanilla extract","note":null,"is_optional":false,"food_id":"vanilla-extract"},{"quantity":250,"unit":"g","name":"all-purpose flour","note":null,"is_optional":false,"food_id":"all-purpose-flour"},{"quantity":0.5,"unit":"tsp","name":"baking soda","note":null,"is_optional":false,"food_id":"baking-soda"},{"quantity":200,"unit":"g","name":"dark chocolate","note":"chopped","is_optional":false,"food_id":"dark-chocolate"}]}]$sr$::jsonb,
  ...
  perform seed_recipe_v2(
    ...
    30, 40, 4, 'public',
    NULL,
    $sr$[{"name":"Marinade","ingredients":[{"quantity":600,"unit":"g","name":"boneless chicken thigh","note":"cubed","is_optional":false,"food_id":"chicken-thigh"},{"quantity":150,"unit":"g","name":"plain yoghurt","note":null,"is_optional":false,"food_id":"yogurt"},{"quantity":1,"unit":"Tbsp","name":"tikka spice blend","note":"half of the 2 Tbsp total","is_optional":false,"food_id":null}]},{"name":"Gravy","ingredients":[{"quantity":2,"unit":"Tbsp","name":"butter","note":null,"is_optional":false,"food_id":"butter"},{"quantity":1,"unit":null,"name":"onion","note":"finely diced","is_optional":false,"food_id":"onion"},{"quantity":3,"unit":"cloves","name":"garlic","note":"minced","is_optional":false,"food_id":"garlic"},{"quantity":1,"unit":"Tbsp","name":"ginger","note":"grated","is_optional":false,"food_id":"ginger"},{"quantity":1,"unit":"Tbsp","name":"tikka spice blend","note":"the other half","is_optional":false,"food_id":null},{"quantity":400,"unit":"g","name":"tomato passata","note":null,"is_optional":false,"food_id":"tomato-passata"},{"quantity":120,"unit":"ml","name":"heavy cream","note":null,"is_optional":false,"food_id":"heavy-cream"}]}]$sr$::jsonb,
...
Mocktail: replace the tequila and orange liqueur with 6 oz lime sparkling water and a squeeze of lemon.$sr$,
    ...
    5, 12, 2, 'public',
    $sr$Secret Sauce Kitchen$sr$,
    $sr$[{"name":"Simple syrup","ingredients":[{"quantity":0.5,"unit":"cup","name":"organic granulated cane sugar","note":null,"is_optional":false,"food_id":"granulated-sugar"},{"quantity":0.5,"unit":"cup","name":"filtered water","note":null,"is_optional":false,"food_id":"water"}]},{"name":"Margarita","ingredients":[{"quantity":4,"unit":null,"name":"limes","note":"juiced, about 4 oz","is_optional":false,"food_id":"lime"},{"quantity":1,"unit":null,"name":"orange","note":"juiced, about 2 oz","is_optional":false,"food_id":"orange"},{"quantity":4,"unit":"oz","name":"tequila blanco","note":null,"is_optional":false,"food_id":"tequila"},{"quantity":2,"unit":"oz","name":"orange liqueur","note":null,"is_optional":false,"food_id":null},{"quantity":null,"unit":null,"name":"ice","note":null,"is_optional":false,"food_id":"water"}]}]$sr$::jsonb,
  ...
  perform seed_recipe_v2(
    ...
    $sr$[{"name":"Dough","ingredients":[{"quantity":250,"unit":"g","name":"00 pizza flour","note":null,"is_optional":false,"food_id":"all-purpose-flour"},{"quantity":160,"unit":"ml","name":"water","note":"warm","is_optional":false,"food_id":"water"},{"quantity":3,"unit":"g","name":"active dry yeast","note":null,"is_optional":false,"food_id":"active-dry-yeast"},{"quantity":5,"unit":"g","name":"salt","note":null,"is_optional":false,"food_id":"kosher-salt"}]},{"name":"Topping","ingredients":[{"quantity":150,"unit":"g","name":"San Marzano tomatoes","note":"crushed","is_optional":false,"food_id":"san-marzano-tomatoes"},{"quantity":125,"unit":"g","name":"fresh mozzarella","note":"torn","is_optional":false,"food_id":"mozzarella"},{"quantity":null,"unit":null,"name":"fresh basil leaves","note":null,"is_optional":false,"food_id":"basil-fresh"},{"quantity":1,"unit":"Tbsp","name":"extra-virgin olive oil","note":null,"is_optional":false,"food_id":"olive-oil"}]}]$sr$::jsonb,
  ...
  perform seed_recipe_v2(
    ...
    10, 15, 4, 'public',
    NULL,
    $sr$[{"name":"Dry","ingredients":[{"quantity":200,"unit":"g","name":"all-purpose flour","note":null,"is_optional":false,"food_id":"all-purpose-flour"},{"quantity":2,"unit":"Tbsp","name":"sugar","note":null,"is_optional":false,"food_id":"granulated-sugar"},{"quantity":1,"unit":"tsp","name":"baking powder","note":null,"is_optional":false,"food_id":"baking-powder"},{"quantity":0.5,"unit":"tsp","name":"baking soda","note":null,"is_optional":false,"food_id":"baking-soda"},{"quantity":0.5,"unit":"tsp","name":"salt","note":null,"is_optional":false,"food_id":"kosher-salt"}]},{"name":"Wet","ingredients":[{"quantity":300,"unit":"ml","name":"buttermilk","note":null,"is_optional":false,"food_id":"buttermilk"},{"quantity":1,"unit":null,"name":"egg","note":null,"is_optional":false,"food_id":"egg"},{"quantity":40,"unit":"g","name":"butter","note":"melted","is_optional":false,"food_id":"butter"}]}]$sr$::jsonb,
  ...
  perform seed_recipe_v2(
    ...
    15, 0, 4, 'public',
    NULL,
    $sr$[{"name":"","ingredients":[{"quantity":3,"unit":null,"name":"ripe avocados","note":null,"is_optional":false,"food_id":"avocado"},{"quantity":1,"unit":null,"name":"lime","note":"juiced","is_optional":false,"food_id":"lime"},{"quantity":0.5,"unit":null,"name":"red onion","note":"finely diced","is_optional":false,"food_id":"onion"},{"quantity":1,"unit":null,"name":"jalapeño","note":"minced","is_optional":false,"food_id":"jalapeno"},{"quantity":null,"unit":null,"name":"fresh coriander","note":"chopped","is_optional":false,"food_id":"coriander"},{"quantity":null,"unit":null,"name":"salt","note":"to taste","is_optional":false,"food_id":"kosher-salt"}]}]$sr$::jsonb,
  ...
  perform seed_recipe_v2(
    ...
    15, 35, 16, 'public',
    $sr$Secret Sauce Kitchen$sr$,
    $sr$[{"name":"","ingredients":[{"quantity":0.5,"unit":"cup","name":"butter","note":"plus more for the pan","is_optional":false,"food_id":"butter"},{"quantity":0.75,"unit":"cup","name":"unsweetened cocoa powder","note":null,"is_optional":false,"food_id":"cocoa-powder"},{"quantity":0.5,"unit":"cup","name":"granulated cane sugar","note":null,"is_optional":false,"food_id":"granulated-sugar"},{"quantity":0.5,"unit":"cup","name":"brown sugar","note":null,"is_optional":false,"food_id":"brown-sugar"},{"quantity":2,"unit":null,"name":"eggs","note":"beaten","is_optional":false,"food_id":"egg"},{"quantity":1,"unit":"tsp","name":"vanilla","note":null,"is_optional":false,"food_id":"vanilla-extract"},{"quantity":0.75,"unit":"cup","name":"unbleached wheat flour","note":null,"is_optional":false,"food_id":"unbleached-flour"},{"quantity":6,"unit":"oz","name":"fresh raspberries","note":null,"is_optional":false,"food_id":"raspberries"},{"quantity":0.5,"unit":"cup","name":"chocolate chips","note":null,"is_optional":true,"food_id":"chocolate-chips"}]}]$sr$::jsonb,
  ...
  perform seed_recipe_v2(
    ...
    20, 55, 3, 'public',
    $sr$Secret Sauce Kitchen$sr$,
    $sr$[{"name":"","ingredients":[{"quantity":2,"unit":"Tbsp","name":"olive oil","note":"divided","is_optional":false,"food_id":"olive-oil"},{"quantity":1,"unit":null,"name":"eggplant","note":null,"is_optional":false,"food_id":"eggplant"},{"quantity":2,"unit":null,"name":"zucchini","note":"small","is_optional":false,"food_id":"zucchini"},{"quantity":1,"unit":null,"name":"red bell pepper","note":null,"is_optional":false,"food_id":"red-bell-pepper"},{"quantity":1,"unit":"pint","name":"cherry tomatoes","note":null,"is_optional":false,"food_id":"cherry-tomatoes"},{"quantity":0.5,"unit":"tsp","name":"kosher salt","note":null,"is_optional":false,"food_id":"kosher-salt"},{"quantity":0.25,"unit":"tsp","name":"black pepper","note":null,"is_optional":false,"food_id":"black-pepper"},{"quantity":1,"unit":null,"name":"yellow onion","note":"chopped","is_optional":false,"food_id":"onion"},{"quantity":4,"unit":"cloves","name":"garlic","note":"minced","is_optional":false,"food_id":"garlic"},{"quantity":0.5,"unit":"bunch","name":"basil","note":"chopped","is_optional":false,"food_id":"basil-fresh"},{"quantity":null,"unit":null,"name":"salt and pepper","note":"to taste","is_optional":false,"food_id":null},{"quantity":null,"unit":null,"name":"hot cooked pasta, polenta, or crusty bread","note":"for serving","is_optional":false,"food_id":null}]}]$sr$::jsonb,
  ...
  perform seed_recipe_v2(
    ...
    15, 0, 4, 'public',
    $sr$Secret Sauce Kitchen$sr$,
    $sr$[{"name":"","ingredients":[{"quantity":4,"unit":null,"name":"Persian cucumbers","note":"1/2-inch dice; or 2 green cucumbers, peeled and seeded","is_optional":false,"food_id":"cucumber"},{"quantity":1,"unit":"pint","name":"cherry tomatoes","note":"quartered","is_optional":false,"food_id":"cherry-tomatoes"},{"quantity":0.5,"unit":"cup","name":"red onion","note":"chopped","is_optional":false,"food_id":"onion"},{"quantity":2,"unit":"Tbsp","name":"fresh dill","note":"chopped; cilantro, parsley, mint, or basil all work","is_optional":false,"food_id":"dill"},{"quantity":1,"unit":"Tbsp","name":"olive oil","note":null,"is_optional":false,"food_id":"olive-oil"},{"quantity":1,"unit":"Tbsp","name":"golden balsamic vinegar","note":null,"is_optional":true,"food_id":"balsamic-vinegar"},{"quantity":1,"unit":null,"name":"lemon","note":"zest and juice","is_optional":false,"food_id":"lemon"},{"quantity":2,"unit":"cloves","name":"garlic","note":"large, smashed and minced","is_optional":false,"food_id":"garlic"},{"quantity":null,"unit":null,"name":"salt and pepper","note":"to taste","is_optional":false,"food_id":null}]}]$sr$::jsonb,
  ...
  perform seed_recipe_v2(
    ...
    $sr$[{"name":"","ingredients":[{"quantity":200,"unit":"g","name":"spaghetti","note":null,"is_optional":false,"food_id":"spaghetti"},{"quantity":4,"unit":"cloves","name":"garlic","note":"thinly sliced","is_optional":false,"food_id":"garlic"},{"quantity":60,"unit":"ml","name":"extra-virgin olive oil","note":null,"is_optional":false,"food_id":"olive-oil"},{"quantity":1,"unit":"tsp","name":"red chilli flakes","note":null,"is_optional":false,"food_id":"red-pepper-flakes"},{"quantity":null,"unit":null,"name":"flat-leaf parsley","note":"chopped","is_optional":false,"food_id":"flat-leaf-parsley"},{"quantity":null,"unit":null,"name":"salt","note":"for the pasta water, and to taste","is_optional":false,"food_id":"kosher-salt"}]}]$sr$::jsonb,
  ...
  perform seed_recipe_v2(
    ...
    30, 55, 8, 'public',
    $sr$Secret Sauce Kitchen$sr$,
    $sr$[{"name":"Crust","ingredients":[{"quantity":1.25,"unit":"cup","name":"organic unbleached wheat flour","note":null,"is_optional":false,"food_id":"unbleached-flour"},{"quantity":0.5,"unit":"tsp","name":"kosher salt","note":null,"is_optional":false,"food_id":"kosher-salt"},{"quantity":6,"unit":"Tbsp","name":"butter","note":"cold, cut into 1/2-inch cubes","is_optional":false,"food_id":"butter"},{"quantity":3,"unit":"Tbsp","name":"ice water","note":"start with 2 Tbsp and add as needed","is_optional":false,"food_id":"water"}]},{"name":"Filling","ingredients":[{"quantity":2,"unit":"Tbsp","name":"butter","note":null,"is_optional":false,"food_id":"butter"},{"quantity":1,"unit":null,"name":"yellow onion","note":"chopped","is_optional":false,"food_id":"onion"},{"quantity":1,"unit":null,"name":"leek","note":"large, thinly sliced, tough leaves removed","is_optional":false,"food_id":"leek"},{"quantity":2,"unit":"cloves","name":"garlic","note":"smashed and minced","is_optional":false,"food_id":"garlic"},{"quantity":1,"unit":"pkg","name":"prosciutto","note":"thinly sliced","is_optional":false,"food_id":"prosciutto"},{"quantity":0.5,"unit":"cup","name":"peas","note":null,"is_optional":false,"food_id":"peas"},{"quantity":0.5,"unit":"cup","name":"parmesan","note":"shredded","is_optional":false,"food_id":"parmesan"},{"quantity":0.5,"unit":"cup","name":"Gruyère","note":"shredded","is_optional":false,"food_id":"gruyere"},{"quantity":0.25,"unit":"cup","name":"smoked Gouda","note":"shredded","is_optional":false,"food_id":"smoked-gouda"},{"quantity":1,"unit":"tsp","name":"poultry seasoning","note":null,"is_optional":false,"food_id":"poultry-seasoning"},{"quantity":null,"unit":null,"name":"salt and pepper","note":"to taste","is_optional":false,"food_id":null},{"quantity":2,"unit":null,"name":"eggs","note":null,"is_optional":false,"food_id":"egg"},{"quantity":0.5,"unit":"cup","name":"whole milk","note":null,"is_optional":false,"food_id":"whole-milk"}]},{"name":"To assemble","ingredients":[{"quantity":1,"unit":"Tbsp","name":"Dijon mustard","note":null,"is_optional":false,"food_id":"dijon-mustard"},{"quantity":0.5,"unit":"bunch","name":"asparagus","note":"trimmed","is_optional":false,"food_id":"asparagus"}]}]$sr$::jsonb,
  ...
  perform seed_recipe_v2(
    ...
    25, 15, 4, 'public',
    $sr$Secret Sauce Kitchen$sr$,
    $sr$[{"name":"Teriyaki sauce","ingredients":[{"quantity":0.5,"unit":"cup","name":"mirin","note":null,"is_optional":false,"food_id":null},{"quantity":0.5,"unit":"cup","name":"pineapple juice","note":"orange juice also works","is_optional":false,"food_id":"pineapple-juice"},{"quantity":0.25,"unit":"cup","name":"tamari","note":null,"is_optional":false,"food_id":"tamari"},{"quantity":3,"unit":"Tbsp","name":"honey","note":null,"is_optional":false,"food_id":"honey"},{"quantity":1,"unit":"Tbsp","name":"rice vinegar","note":null,"is_optional":false,"food_id":"rice-vinegar"},{"quantity":2,"unit":"cloves","name":"garlic","note":"grated","is_optional":false,"food_id":"garlic"},{"quantity":1,"unit":"inch","name":"fresh ginger","note":"grated","is_optional":false,"food_id":"ginger"},{"quantity":1,"unit":"tsp","name":"red pepper flakes","note":"or to taste","is_optional":false,"food_id":"red-pepper-flakes"},{"quantity":1,"unit":"tsp","name":"cornstarch","note":null,"is_optional":false,"food_id":"cornstarch"},{"quantity":1,"unit":"Tbsp","name":"water","note":null,"is_optional":false,"food_id":"water"}]},{"name":"Pork and skewers","ingredients":[{"quantity":1,"unit":"lb","name":"pork","note":"cut for kabobs","is_optional":false,"food_id":"pork-tenderloin"},{"quantity":1,"unit":"Tbsp","name":"olive oil","note":null,"is_optional":false,"food_id":"olive-oil"},{"quantity":2,"unit":"tsp","name":"tamari","note":null,"is_optional":false,"food_id":"tamari"},{"quantity":1,"unit":"tsp","name":"smoked paprika","note":null,"is_optional":false,"food_id":"smoked-paprika"},{"quantity":null,"unit":null,"name":"salt and black pepper","note":"to taste","is_optional":false,"food_id":null},{"quantity":1,"unit":null,"name":"pineapple","note":"small, skin and core removed","is_optional":false,"food_id":"pineapple"},{"quantity":1,"unit":null,"name":"red bell pepper","note":"stemmed and seeded","is_optional":false,"food_id":"red-bell-pepper"},{"quantity":1,"unit":null,"name":"yellow onion","note":null,"is_optional":false,"food_id":"onion"},{"quantity":6,"unit":null,"name":"bamboo skewers","note":"4-6, soaked in water at least 30 minutes","is_optional":false,"food_id":null}]}]$sr$::jsonb,
...
Form larger patties instead of six small ones and serve them on buns as fish burgers.$sr$,
    ...
    15, 10, 2, 'public',
    $sr$Secret Sauce Kitchen$sr$,
    $sr$[{"name":"","ingredients":[{"quantity":1,"unit":"pouch","name":"tuna","note":"3 oz pouch or 5 oz can, drained","is_optional":false,"food_id":"tuna"},{"quantity":1,"unit":"Tbsp","name":"butter","note":null,"is_optional":false,"food_id":"butter"},{"quantity":0.5,"unit":"cup","name":"yellow onion","note":"minced","is_optional":false,"food_id":"onion"},{"quantity":2,"unit":"cloves","name":"garlic","note":"minced","is_optional":false,"food_id":"garlic"},{"quantity":0.5,"unit":"cup","name":"panko bread crumbs","note":null,"is_optional":false,"food_id":"panko"},{"quantity":0.25,"unit":"cup","name":"parmesan","note":"grated","is_optional":false,"food_id":"parmesan"},{"quantity":2,"unit":null,"name":"mini sweet peppers","note":"1/4-inch dice","is_optional":false,"food_id":"mini-sweet-peppers"},{"quantity":2,"unit":null,"name":"green onions","note":"minced","is_optional":false,"food_id":"green-onions"},{"quantity":1,"unit":null,"name":"egg","note":null,"is_optional":false,"food_id":"egg"},{"quantity":1,"unit":"Tbsp","name":"lemon juice","note":null,"is_optional":false,"food_id":"lemon-juice"},{"quantity":1,"unit":null,"name":"lemon","note":"zest only","is_optional":false,"food_id":"lemon"},{"quantity":0.5,"unit":"tsp","name":"kosher salt","note":null,"is_optional":false,"food_id":"kosher-salt"},{"quantity":0.25,"unit":"tsp","name":"black pepper","note":null,"is_optional":false,"food_id":"black-pepper"},{"quantity":0.5,"unit":"tsp","name":"smoked paprika","note":null,"is_optional":false,"food_id":"smoked-paprika"},{"quantity":0.25,"unit":"tsp","name":"garlic powder","note":null,"is_optional":false,"food_id":"garlic-powder"},{"quantity":null,"unit":null,"name":"oil","note":"for frying","is_optional":false,"food_id":"canola-oil"}]}]$sr$::jsonb,
